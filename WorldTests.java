...
public class WorldTests {
    ...
    public void testFairyAnimation() {
        ...
        assertEquals(1, entities.size());
        assertEquals("myfairy 0 0 10", entities.get(0)); // imageIndex = 0??
    }
    ...
    public void testTrampleFull() {
        ...
        List<String> entities = VirtualWorld.headlessMain(new String[]{sav}, 10);
        assertEquals(0, entities.size());
        // called into Activity(dude not full) instead of dude full
    }
    ...
    public void testFairyPathing() {
        ...
        assertEquals(1, entities.size());
        assertEquals("myfairy 10 11 0", entities.get(0)); // y position not matching
    }
    ...
    public void testDudeTransformNotFull() {
        ...
        assertEquals(1, entities.size()); // 2
        assertEquals("mydude 3 1 0", entities.get(0)); // 1 1 8
    }
    ...
    @Test
    public void testAStar_NoObstacles()
    {
        boolean[][] grid = {
                {true, true, true},
                {true, true, true},
    ...
    @Test
    public void testAStar_ObstacleBelow()
    {
        boolean[][] grid = {
                {true, true, false},
                {false, true, true},
    ...
    @Test
    public void testAStar_SameEndpoints()
    {
        boolean[][] grid = {
                {true, true, true},
                {true, true, true},
...
//    @Test
//    public void testAStar_EndpointsOutOfBounds()
//    {
//        boolean[][] grid = {
//                {true, true, true},
//                {true, true, true},
...
//    }
    ...
    @Test
    public void testAStar_LargeGrid()
    {
        boolean[][] grid = {
    ...
    @Test
    public void testAStar_ComplicatedPath()
    {
        boolean[][] grid = {
                {true, true, false, true, true},
    ...
    @Test
    public void testAStar_ComplicatedPath2()
    {
        boolean[][] grid = {
                {true, true, false, true, true},
                {true, true, false, true, true},
